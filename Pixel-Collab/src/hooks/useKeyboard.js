...
export const useKeyboard = () => {
    ...
    const handleKeyDown = (e) => {
      ...
      if (!ctrl && !shift) {
        switch (e.key.toLowerCase()) {
          ...
          case 'delete':
          case 'backspace': deleteElements(selectedIds); break;
        }
      }
  ...
  }, [setActiveTool, undo, redo, deleteElements, selectedIds, clearSelection, zoomIn, zoomOut, resetZoom, isEditingText]);
};
